    ...
    if (m_shieldDirty) {
        ...
        for (const auto& s : m_shields) {
            for (const auto& b : s.getBlocks()) {
                ...
                m_shieldVerts[vi + 0] = { tl,col }; m_shieldVerts[vi + 1] = { tr,col };
                m_shieldVerts[vi + 2] = { br,col }; m_shieldVerts[vi + 3] = { tl,col };
                m_shieldVerts[vi + 4] = { br,col }; m_shieldVerts[vi + 5] = { bl,col };
                vi += 6;
            }
        }
        m_shieldDirty = false;
